...
public static void main(String[] args) {
		...
		Course history = new Course("American History", 5, 5);
		...
		System.out.println("\nSetting roster size to 101 should return true: " + history.setRosterSize(101) + " (but trimmed down to maximum allowed of 100)");
		System.out.println("Setting waitlist size to 30 should return true: " + history.setWaitlistSize(30) + " (but trimmed down to maximum allowed of 25)");
